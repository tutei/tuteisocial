...
<div class="content-view-full">
    <div class="class-shiva3d">
		...
		<script src="http://www.stonetrip.com/players/stkobject.js" type="text/javascript"></script>


		<div align="center" id="S3DContent">

			<script  language="javascript" type="text/javascript">
			   stkobject( "{$width}" , "{$height}" , "{concat('http://', ezini('SiteSettings', 'SiteURL', 'site.ini')|explode('/index.php')[0],'/content/download/',$node.data_map.shiva3d.contentobject_id,'/',$node.data_map.shiva3d.id,'/file/',$node.data_map.shiva3d.content.original_filename)}" );
			</script>
