...
<div class="content-view-full">
    <div class="class-panda3d">
		...
		{ezscript_require( array('RunPanda3D.js', 'DetectPanda3D.js') )}


		<script type="text/javascript">
		if (detectPanda3D()) {ldelim}
			P3D_RunContent('data', '{concat('http://', ezini('SiteSettings', 'SiteURL', 'site.ini')|explode('/index.php')[0],'/content/download/',$node.data_map.panda3d.contentobject_id,'/',$node.data_map.panda3d.id,'/file/',$node.data_map.panda3d.content.original_filename)}', 'id', 'gameApp','width', '{$width}', 'height', '{$height}');
		{rdelim}
		else 
		{ldelim}
		   document.write('<a href="http://www.panda3d.org/download.php?runtime">You need to download Panda3d Runtime</a>');
		{rdelim}
		</script>
